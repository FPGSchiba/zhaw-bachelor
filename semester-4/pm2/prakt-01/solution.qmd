...
result |>
    ...
    labs(
        x = "Wochentag",
        y = expression("log(PM10 Konzentration)" ~ "(µg/m³)"), # Update y-axis label to reflect log transformation
    ) +
    theme_light() + # Use a light theme for better contrast
    theme(
        axis.title = element_text(size = 14),
...
Notes: Log transformiert macht die Ausreisser nach unten und oben sehr viel besser sichtbar.
