...
-- DROP it again :(
/*
DROP TABLE IF EXISTS Besucher CASCADE;
DROP TABLE IF EXISTS Restaurant CASCADE;
DROP TABLE IF EXISTS Biersorte CASCADE;
DROP TABLE IF EXISTS Gast CASCADE;
DROP TABLE IF EXISTS Lieblingsbier CASCADE;
